...
<div class="w3-container">
    <h2 style="text-align: center"><spring:message code="application.city.plural"/></h2>
    <br>
    <a href="<c:url value="/" />" class="w3-button"><spring:message code="application.button.return"/></a>
    <a href="<c:url value="/countries" />" class="w3-button"><spring:message code="application.country.plural"/></a>
    ...
    <div class="w3-container w3-center">
        ...
        <table id="citiesTable" class="w3-centered w3-table-all">
            ...
            <tr class="w3-light-grey">
                <th>Id</th>
                <th><spring:message code="application.city.singular"/></th>
            ...
            <c:forEach items="${cities}" var="elem">
                <tr>
                    ...
                    <td><a href="<c:url value="/city?id=${elem.id}" />" class="w3-button"><spring:message code="application.button.see"/></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
