...
<h2 style="text-align: center"><spring:message code="application.country.singular"/></h2>
<br>
<a href="<c:url value="/countries" />" class="w3-button"><spring:message code="application.button.return"/></a>
